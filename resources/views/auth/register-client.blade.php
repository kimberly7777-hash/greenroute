...
<head>
    ...
    <title>Client Registration - AFIA IT Orbit Department</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="subtitle">Client Registration</div>
        </div>
        
        <div class="form-container">
            <h2 class="form-title">Create Your Client Account</h2>
            ...
            <form method="POST" action="{{ route('register.client.store') }}">
                ...
                <div class="form-footer">
                    Already have an account? <a href="{{ route('login.client') }}">Login here</a>
                </div>
            </form>
        </div>
    </div>
