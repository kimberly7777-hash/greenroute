...
<head>
    ...
    <title>Administrator Registration - AFIA IT Orbit Department</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="subtitle">Administrator Registration</div>
        </div>
        
        <div class="form-container">
            <h2 class="form-title">Create Administrator Account</h2>
            ...
            <form method="POST" action="{{ route('register.admin.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="employee_id" type="text" class="form-input" name="employee_id" value="{{ old('employee_id') }}" required>
                </div>
                
                <div class="form-group">
                    <label for="department" class="form-label">Department</label>
                    <input id="department" type="text" class="form-input" name="department" value="{{ old('department') }}" required>
                </div>
